    ...
    public class SpartanSettingProvider : SettingProvider
    {
        public override IEnumerable<SettingDefinition> GetSettingDefinitions(SettingDefinitionProviderContext context)
        {
            return new[]
            {
                ...
                new SettingDefinition(SpartanSettingKeys.General_ActiveMq_Gateway_Event_Name,GetDefaultSetting(SpartanSettingKeys.General_ActiveMq_Gateway_Event_Name,"GatewayEvent"),L("网关事件队列名字")),
                new SettingDefinition(SpartanSettingKeys.General_ActiveMq_Gateway_Event_Uri,GetDefaultSetting(SpartanSettingKeys.General_ActiveMq_Gateway_Event_Uri,"tcp://localhost:61616"),L("网关事件队列地址")),
                new SettingDefinition(SpartanSettingKeys.General_ActiveMq_Web_Event_Name,GetDefaultSetting(SpartanSettingKeys.General_ActiveMq_Web_Event_Name,"WebEvent"),L("Web事件队列名字")),
                new SettingDefinition(SpartanSettingKeys.General_ActiveMq_Web_Event_Uri,GetDefaultSetting(SpartanSettingKeys.General_ActiveMq_Web_Event_Uri,"tcp://localhost:61616"),L("Web事件队列地址")),
                //租户
