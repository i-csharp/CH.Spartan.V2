    ...
    public class SpartanSettingProvider : SettingProvider
    {
        public override IEnumerable<SettingDefinition> GetSettingDefinitions(SettingDefinitionProviderContext context)
        {
            return new[]
            {
                ...
                new SettingDefinition(SpartanSettingKeys.General_ActiveMq_Gateway_Event_Name,GetDefaultSetting(SpartanSettingKeys.General_ActiveMq_Gateway_Event_Name,"Message"),L("网关事件队列名字")),
                ...
                new SettingDefinition(SpartanSettingKeys.General_ActiveMq_Web_Event_Name,GetDefaultSetting(SpartanSettingKeys.General_ActiveMq_Web_Event_Name,"Event"),L("Web事件队列名字")),
